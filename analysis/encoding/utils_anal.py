...
def get_network_labels(num_parc, num_net):
    ...
    """
    ## get filename ##
    abs_path = '/jukebox/graziano/coolCatIsaac/MEI/code/analysis'
    label_fn = f'{abs_path}/brainiak-aperture-isc-data/Schaefer2018_{num_parc}Parcels_{num_net}Networks_order.txt'
