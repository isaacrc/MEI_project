...
results_dir = 'model1/model_1_results_sklearn/averaged'
    ...
    for run in runs:
        for data_type in data_types:
            ...
            for train_index, test_index in loo.split(data):
                ...
                train_labels_subjects = [trim_emb for _ in train_index]
                ...
                ridge.fit(train_labels_mean, train_data_mean)
...
for mov in movies:
    ...
    pdf_path = os.path.join(results_dir, f"model1_{mov}_results_sklearn_averaged.pdf")  
